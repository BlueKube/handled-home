...
export type ProviderIssueType = "access_failure" | "provider_unavailable" | "weather_safety" | "quality_block";
...
export const PROVIDER_ISSUE_REASON_CODES: ProviderIssueReasonCode[] = [
  ...
  // Unavailable
  { value: "sick", label: "Sick / can't work today", issueType: "provider_unavailable" },
  { value: "vehicle_issue", label: "Vehicle issue", issueType: "provider_unavailable" },
  { value: "personal_emergency", label: "Personal emergency", issueType: "provider_unavailable" },

  // Weather
  { value: "severe_weather", label: "Severe weather", issueType: "weather_safety" },
  { value: "unsafe_conditions", label: "Unsafe conditions (lightning, ice)", issueType: "weather_safety" },
...
export const PROVIDER_ISSUE_TYPES: { value: ProviderIssueType; label: string; description: string }[] = [
  ...
  { value: "provider_unavailable", label: "I'm unavailable", description: "Sick, vehicle issue, or emergency" },
  { value: "weather_safety", label: "Weather / safety", description: "Severe weather or unsafe conditions" },
