...
import {
  ...
  AppWindow as AppWindowIcon, Droplets, Wrench,
  Trees, Layers,
} from "lucide-react";
...
// ════════════════════════════════════════
// Home Setup Step (Coverage Map + Property Sizing)
// ════════════════════════════════════════
...
function HomeSetupStep({ onComplete }: { onComplete: () => Promise<void> }) {
    ...
    return (
      <div className="space-y-5">
        <div className="text-center">
          ...
          <p className="text-muted-foreground text-sm mt-1">
            What's already handled at your home? This takes about 30 seconds.
          </p>
        </div>
