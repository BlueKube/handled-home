    ...
    steps: [
      {
        ...
        screenshot: { src: "/academy/billing-dashboard.png", alt: "Billing dashboard top-line revenue metrics" },
      },
      {
        ...
        screenshot: { src: "/academy/billing-dashboard.png", alt: "Billing dashboard failed payments and past-due metrics" },
      },
      {
        ...
        screenshot: { src: "/academy/subscriptions.png", alt: "Subscription distribution chart by tier" },
      },
      {
        ...
        screenshot: { src: "/academy/billing-ops.png", alt: "Billing cycle health indicator" },
      },
      {
        ...
        screenshot: { src: "/academy/billing-dashboard.png", alt: "MRR trend chart on billing dashboard" },
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        screenshot: { src: "/academy/billing-ops.png", alt: "Customer billing ledger showing charge history" },
      },
      {
        ...
        screenshot: { src: "/academy/billing-ops.png", alt: "Dunning step indicator on customer billing page" },
      },
      {
        ...
        screenshot: { src: "/academy/billing-ops.png", alt: "Payment method details with Stripe decline code" },
      },
      {
        ...
        screenshot: { src: "/academy/billing-ops.png", alt: "Customer service history and issue log" },
      },
      {
        ...
        screenshot: { src: "/academy/billing-ops.png", alt: "Billing intervention options on customer account" },
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        screenshot: { src: "/academy/billing-ops.png", alt: "Customer ledger with entry types labeled" },
      },
      {
        ...
        screenshot: { src: "/academy/billing-ops.png", alt: "Customer ledger sorted chronologically" },
      },
      {
        ...
        screenshot: { src: "/academy/billing-ops.png", alt: "Ledger credit entry with admin note field" },
      },
      {
        ...
        screenshot: { src: "/academy/billing-ops.png", alt: "Dispute entry in ledger with response deadline" },
      },
    ],
  },
  {
