    ...
    steps: [
      {
        ...
        screenshot: { src: "/academy/payouts-dashboard.png", alt: "Provider payout schedule showing Friday processing" },
      },
      {
        ...
        screenshot: { src: "/academy/payouts-dashboard.png", alt: "Pending payout batch view showing provider amounts" },
      },
      {
        ...
        screenshot: { src: "/academy/payouts-dashboard.png", alt: "Processed payout batch with success and failure indicators" },
      },
      {
        ...
        screenshot: { src: "/academy/ops-cron-health.png", alt: "Cron Health page showing payout job status" },
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        screenshot: { src: "/academy/payouts-dashboard.png", alt: "Provider earning with hold type indicator" },
      },
      {
        ...
        screenshot: { src: "/academy/payouts-dashboard.png", alt: "Earning detail showing hold reason and flags" },
      },
      {
        ...
        screenshot: { src: "/academy/payouts-dashboard.png", alt: "Hold release confirmation dialog with note field" },
      },
      {
        ...
        screenshot: { src: "/academy/payouts-dashboard.png", alt: "Provider account showing multiple held earnings" },
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        screenshot: { src: "/academy/payouts-dashboard.png", alt: "Provider Stripe Connect status on provider detail page" },
      },
      {
        ...
        screenshot: { src: "/academy/payouts-dashboard.png", alt: "Provider Stripe Connect onboarding status" },
      },
      {
        ...
        screenshot: { src: "/academy/payouts-dashboard.png", alt: "Restricted Stripe Connect account detail" },
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        screenshot: { src: "/academy/payouts-dashboard.png", alt: "Payout batch report with status column" },
      },
      {
        ...
        screenshot: { src: "/academy/payouts-dashboard.png", alt: "Payout failure detail with Stripe reason code" },
      },
      {
        ...
        screenshot: { src: "/academy/payouts-dashboard.png", alt: "Provider payout record showing resolved status" },
      },
      {
        ...
        screenshot: { src: "/academy/payouts-dashboard.png", alt: "Platform Stripe balance check" },
      },
    ],
  },
  {
