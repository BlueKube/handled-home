    ...
    steps: [
      {
        ...
        screenshot: { src: "/academy/provider-applications.png", alt: "Provider application review screen with status filters" },
      },
      {
        ...
        screenshot: { src: "/academy/provider-applications.png", alt: "Background check initiation and status tracker" },
      },
      {
        ...
        screenshot: { src: "/academy/provider-applications.png", alt: "Provider document upload and verification checklist" },
      },
      {
        ...
        screenshot: { src: "/academy/provider-list.png", alt: "Provider territory and service type assignment interface" },
      },
      {
        ...
        screenshot: { src: "/academy/provider-list.png", alt: "Provider Stripe Connect status in payout settings" },
      },
      {
        ...
        screenshot: { src: "/academy/provider-list.png", alt: "Provider training completion checklist in onboarding record" },
      },
      {
        ...
        screenshot: { src: "/academy/provider-list.png", alt: "Job proof review showing photo grid for first-job audit" },
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        screenshot: { src: "/academy/provider-list.png", alt: "Provider performance dashboard with six KPI summary tiles" },
      },
      {
        ...
        screenshot: { src: "/academy/provider-list.png", alt: "Weekly provider performance report sorted by quality score" },
      },
      {
        ...
        screenshot: { src: "/academy/provider-accountability.png", alt: "Quality flag queue showing open flags with age and provider" },
      },
      {
        ...
        screenshot: { src: "/academy/provider-accountability.png", alt: "Provider proof compliance history chart with threshold markers" },
      },
      {
        ...
        screenshot: { src: "/academy/provider-accountability.png", alt: "Customer feedback detail linked to provider coaching message thread" },
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        screenshot: { src: "/academy/provider-accountability.png", alt: "No-show incident logging form with reason and reassignment status" },
      },
      {
        ...
        screenshot: { src: "/academy/provider-accountability.png", alt: "Quality complaint intake linked to job record and proof photos" },
      },
      {
        ...
        screenshot: { src: "/academy/provider-list.png", alt: "Provider on-time rate trend with service window compliance chart" },
      },
      {
        ...
        screenshot: { src: "/academy/provider-list.png", alt: "Provider communication log with message read receipts and response times" },
      },
      {
        ...
        screenshot: { src: "/academy/provider-accountability.png", alt: "Probation initiation form with trigger documentation and review window" },
      },
      {
        ...
        screenshot: { src: "/academy/provider-accountability.png", alt: "Probation review summary comparing trigger metrics to review period performance" },
      },
    ],
  },
  {
