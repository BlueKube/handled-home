-- ============================================================
-- Fix test user roles & seed rich metro data
--
-- Problem: When customer@test.com, provider@test.com, and admin@test.com
-- first logged in, the self-healing bootstrap in AuthContext created them
-- all as "customer" role (bootstrap_new_user defaults to customer and
-- explicitly blocks admin). The rich metro seed (seed-rich-metro.sql) was
-- never run on the live database because it's a standalone file, not a
-- migration.
--
-- This migration:
--   1. Removes stale test user entries (profiles, user_roles, properties, etc.)
--   2. Deletes and recreates auth.users with canonical UUIDs the seed expects
--   3. Seeds all rich metro data inline (1400+ lines of demo data)
--
...
-- Remove any bootstrapped roles/profiles for test emails
DO $$
DECLARE
  v_old_customer_id uuid;
  v_old_provider_id uuid;
  v_old_admin_id    uuid;
  v_canonical_customer uuid := '7cfa1714-bf93-441f-99c0-4bc3e24a284c';
  v_canonical_provider uuid := 'f4000000-0000-0000-0000-000000000001';
  v_canonical_admin    uuid := 'f4000000-0000-0000-0000-000000000009';
BEGIN
  -- Find existing user IDs (may differ from canonical)
  SELECT id INTO v_old_customer_id FROM auth.users WHERE email = 'customer@test.com';
  SELECT id INTO v_old_provider_id FROM auth.users WHERE email = 'provider@test.com';
  SELECT id INTO v_old_admin_id    FROM auth.users WHERE email = 'admin@test.com';

  -- Clean up customer@test.com if it exists with wrong UUID
  IF v_old_customer_id IS NOT NULL AND v_old_customer_id != v_canonical_customer THEN
    RAISE NOTICE 'Cleaning up customer@test.com (old UUID: %, canonical: %)', v_old_customer_id, v_canonical_customer;
    -- Delete child data in dependency order
    DELETE FROM notification_delivery WHERE notification_id IN (SELECT id FROM notifications WHERE user_id = v_old_customer_id);
    DELETE FROM notifications WHERE user_id = v_old_customer_id;
    DELETE FROM referral_codes WHERE user_id = v_old_customer_id;
    DELETE FROM byoc_activations WHERE customer_user_id = v_old_customer_id;
    DELETE FROM visit_ratings WHERE customer_id = v_old_customer_id;
    DELETE FROM job_issues WHERE created_by_user_id = v_old_customer_id;
    DELETE FROM job_photos WHERE job_id IN (SELECT id FROM jobs WHERE customer_id = v_old_customer_id);
    DELETE FROM job_checklist_items WHERE job_id IN (SELECT id FROM jobs WHERE customer_id = v_old_customer_id);
    DELETE FROM job_skus WHERE job_id IN (SELECT id FROM jobs WHERE customer_id = v_old_customer_id);
    DELETE FROM provider_earnings WHERE job_id IN (SELECT id FROM jobs WHERE customer_id = v_old_customer_id);
    DELETE FROM jobs WHERE customer_id = v_old_customer_id;
    DELETE FROM customer_credits WHERE customer_id = v_old_customer_id;
    DELETE FROM customer_invoices WHERE customer_id = v_old_customer_id;
    DELETE FROM routine_items WHERE routine_version_id IN (
      SELECT rv.id FROM routine_versions rv JOIN routines r ON rv.routine_id = r.id WHERE r.customer_id = v_old_customer_id
    );
    DELETE FROM routine_versions WHERE routine_id IN (SELECT id FROM routines WHERE customer_id = v_old_customer_id);
    DELETE FROM routines WHERE customer_id = v_old_customer_id;
    DELETE FROM service_day_assignments WHERE customer_id = v_old_customer_id;
    DELETE FROM property_health_scores WHERE customer_id = v_old_customer_id;
    DELETE FROM customer_payment_methods WHERE customer_id = v_old_customer_id;
    DELETE FROM subscriptions WHERE customer_id = v_old_customer_id;
    DELETE FROM properties WHERE user_id = v_old_customer_id;
    DELETE FROM support_tickets WHERE customer_id = v_old_customer_id;
    DELETE FROM ops_exceptions WHERE customer_id = v_old_customer_id;
    DELETE FROM admin_audit_log WHERE admin_user_id = v_old_customer_id;
    DELETE FROM admin_change_requests WHERE requester_user_id = v_old_customer_id;
    DELETE FROM user_roles WHERE user_id = v_old_customer_id;
    DELETE FROM profiles WHERE user_id = v_old_customer_id;
    DELETE FROM auth.users WHERE id = v_old_customer_id;
  END IF;

  -- Clean up provider@test.com if it exists with wrong UUID
  IF v_old_provider_id IS NOT NULL AND v_old_provider_id != v_canonical_provider THEN
    RAISE NOTICE 'Cleaning up provider@test.com (old UUID: %, canonical: %)', v_old_provider_id, v_canonical_provider;
    DELETE FROM notification_delivery WHERE notification_id IN (SELECT id FROM notifications WHERE user_id = v_old_provider_id);
    DELETE FROM notifications WHERE user_id = v_old_provider_id;
    DELETE FROM provider_applications WHERE user_id = v_old_provider_id;
    DELETE FROM provider_members WHERE user_id = v_old_provider_id;
    DELETE FROM user_roles WHERE user_id = v_old_provider_id;
    DELETE FROM profiles WHERE user_id = v_old_provider_id;
    DELETE FROM auth.users WHERE id = v_old_provider_id;
  END IF;

  -- Clean up admin@test.com if it exists with wrong UUID
  IF v_old_admin_id IS NOT NULL AND v_old_admin_id != v_canonical_admin THEN
    RAISE NOTICE 'Cleaning up admin@test.com (old UUID: %, canonical: %)', v_old_admin_id, v_canonical_admin;
    DELETE FROM notification_delivery WHERE notification_id IN (SELECT id FROM notifications WHERE user_id = v_old_admin_id);
    DELETE FROM notifications WHERE user_id = v_old_admin_id;
    DELETE FROM admin_audit_log WHERE admin_user_id = v_old_admin_id;
    DELETE FROM admin_change_requests WHERE requester_user_id = v_old_admin_id;
    DELETE FROM user_roles WHERE user_id = v_old_admin_id;
    DELETE FROM profiles WHERE user_id = v_old_admin_id;
    DELETE FROM auth.users WHERE id = v_old_admin_id;
  END IF;

  -- Also clean up any previous seed_demo_data migration data that used wrong IDs
  -- (The 20260309080000 migration hardcoded customer UUID but provider/admin fell through)
  -- These use d2-prefix UUIDs
  DELETE FROM customer_credits WHERE id IN ('d2000000-0000-0000-0000-000000000080', 'd2000000-0000-0000-0000-000000000081');
  DELETE FROM ops_exceptions WHERE id IN ('d2000000-0000-0000-0000-000000000030', 'd2000000-0000-0000-0000-000000000031', 'd2000000-0000-0000-0000-000000000032');
  DELETE FROM provider_applications WHERE id IN ('d2000000-0000-0000-0000-000000000040', 'd2000000-0000-0000-0000-000000000041');
  DELETE FROM job_skus WHERE job_id IN ('d2000000-0000-0000-0000-000000000001', 'd2000000-0000-0000-0000-000000000002', 'd2000000-0000-0000-0000-000000000003', 'd2000000-0000-0000-0000-000000000004', 'd2000000-0000-0000-0000-000000000005');
  DELETE FROM jobs WHERE id IN ('d2000000-0000-0000-0000-000000000001', 'd2000000-0000-0000-0000-000000000002', 'd2000000-0000-0000-0000-000000000003', 'd2000000-0000-0000-0000-000000000004', 'd2000000-0000-0000-0000-000000000005');
  DELETE FROM customer_invoices WHERE id IN ('d2000000-0000-0000-0000-000000000010', 'd2000000-0000-0000-0000-000000000011', 'd2000000-0000-0000-0000-000000000012');
  DELETE FROM routine_items WHERE routine_version_id = 'd2000000-0000-0000-0000-000000000021';
  DELETE FROM routine_versions WHERE id = 'd2000000-0000-0000-0000-000000000021';
  DELETE FROM routines WHERE id = 'd2000000-0000-0000-0000-000000000020';

  RAISE NOTICE 'Test user cleanup complete';
END $$;

-- ── Step 2: Insert the full rich metro seed ──
-- This is the content of supabase/seed-rich-metro.sql, inlined as a migration
-- so it auto-deploys on the Lovable Supabase instance.
...
INSERT INTO auth.users (id, instance_id, email, encrypted_password, raw_user_meta_data, role, aud, email_confirmed_at, created_at, updated_at) VALUES
  -- Core test users (password: 65406540)
  ('7cfa1714-bf93-441f-99c0-4bc3e24a284c', '00000000-0000-0000-0000-000000000000', 'customer@test.com', '$2b$10$7RWtIhqh.Trme4WECsRrzOhcgrZt7d9txffILJursadowA0vU1SRe', '{"full_name":"Test Customer","intended_role":"customer"}'::jsonb, 'authenticated', 'authenticated', now(), now(), now()),
  ('f4000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000000', 'provider@test.com', '$2b$10$7RWtIhqh.Trme4WECsRrzOhcgrZt7d9txffILJursadowA0vU1SRe', '{"full_name":"Test Provider","intended_role":"provider"}'::jsonb, 'authenticated', 'authenticated', now(), now(), now()),
  ('f4000000-0000-0000-0000-000000000009', '00000000-0000-0000-0000-000000000000', 'admin@test.com',    '$2b$10$7RWtIhqh.Trme4WECsRrzOhcgrZt7d9txffILJursadowA0vU1SRe', '{"full_name":"Test Admin","intended_role":"admin"}'::jsonb,    'authenticated', 'authenticated', now(), now(), now()),
  -- Provider org owners
  ('f4000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000000', 'provider-org2@seed.local', '$2b$10$7RWtIhqh.Trme4WECsRrzOhcgrZt7d9txffILJursadowA0vU1SRe', '{"full_name":"Maria G."}'::jsonb,   'authenticated', 'authenticated', now(), now(), now()),
  ('f4000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000000', 'provider-org3@seed.local', '$2b$10$7RWtIhqh.Trme4WECsRrzOhcgrZt7d9txffILJursadowA0vU1SRe', '{"full_name":"James W."}'::jsonb,   'authenticated', 'authenticated', now(), now(), now()),
  ('f4000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000000', 'provider-org4@seed.local', '$2b$10$7RWtIhqh.Trme4WECsRrzOhcgrZt7d9txffILJursadowA0vU1SRe', '{"full_name":"David K."}'::jsonb,   'authenticated', 'authenticated', now(), now(), now()),
  ('f4000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000000', 'provider-org5@seed.local', '$2b$10$7RWtIhqh.Trme4WECsRrzOhcgrZt7d9txffILJursadowA0vU1SRe', '{"full_name":"Sarah L."}'::jsonb,   'authenticated', 'authenticated', now(), now(), now()),
  ('f4000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000000', 'provider-org6@seed.local', '$2b$10$7RWtIhqh.Trme4WECsRrzOhcgrZt7d9txffILJursadowA0vU1SRe', '{"full_name":"Rachel B."}'::jsonb,  'authenticated', 'authenticated', now(), now(), now()),
  ('f4000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000000', 'provider-org7@seed.local', '$2b$10$7RWtIhqh.Trme4WECsRrzOhcgrZt7d9txffILJursadowA0vU1SRe', '{"full_name":"Kevin P."}'::jsonb,   'authenticated', 'authenticated', now(), now(), now()),
  ('f4000000-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000000', 'provider-org8@seed.local', '$2b$10$7RWtIhqh.Trme4WECsRrzOhcgrZt7d9txffILJursadowA0vU1SRe', '{"full_name":"Amanda S."}'::jsonb,  'authenticated', 'authenticated', now(), now(), now()),
  -- Provider org operators (crew members for multi-person orgs)
  ('f4000000-0000-0000-0000-00000000000a', '00000000-0000-0000-0000-000000000000', 'operator-org2a@seed.local', '$2b$10$7RWtIhqh.Trme4WECsRrzOhcgrZt7d9txffILJursadowA0vU1SRe', '{"full_name":"Carlos R."}'::jsonb,  'authenticated', 'authenticated', now(), now(), now()),
  ('f4000000-0000-0000-0000-00000000000b', '00000000-0000-0000-0000-000000000000', 'operator-org3a@seed.local', '$2b$10$7RWtIhqh.Trme4WECsRrzOhcgrZt7d9txffILJursadowA0vU1SRe', '{"full_name":"Tyler M."}'::jsonb,  'authenticated', 'authenticated', now(), now(), now()),
  ('f4000000-0000-0000-0000-00000000000c', '00000000-0000-0000-0000-000000000000', 'operator-org4a@seed.local', '$2b$10$7RWtIhqh.Trme4WECsRrzOhcgrZt7d9txffILJursadowA0vU1SRe', '{"full_name":"Ryan T."}'::jsonb,   'authenticated', 'authenticated', now(), now(), now()),
  ('f4000000-0000-0000-0000-00000000000d', '00000000-0000-0000-0000-000000000000', 'operator-org4b@seed.local', '$2b$10$7RWtIhqh.Trme4WECsRrzOhcgrZt7d9txffILJursadowA0vU1SRe', '{"full_name":"Miguel F."}'::jsonb, 'authenticated', 'authenticated', now(), now(), now()),
  ('f4000000-0000-0000-0000-00000000000e', '00000000-0000-0000-0000-000000000000', 'operator-org5a@seed.local', '$2b$10$7RWtIhqh.Trme4WECsRrzOhcgrZt7d9txffILJursadowA0vU1SRe', '{"full_name":"Jake H."}'::jsonb,   'authenticated', 'authenticated', now(), now(), now())
...
BEGIN
  ...
  SELECT id INTO v_provider_id FROM auth.users WHERE email = 'provider@test.com' LIMIT 1;
...
BEGIN
  SELECT id INTO v_provider_id FROM auth.users
    WHERE email = 'provider@test.com' LIMIT 1;
  IF v_provider_id IS NULL THEN v_provider_id := v_customer_id; END IF;
  SELECT id INTO v_admin_id FROM auth.users
    WHERE email = 'admin@test.com' LIMIT 1;
  IF v_admin_id IS NULL THEN v_admin_id := v_customer_id; END IF;
