-- Step 1: Add applied_cents columns (prerequisite for the RPC below)
ALTER TABLE customer_credits ADD COLUMN IF NOT EXISTS applied_cents int NOT NULL DEFAULT 0;
ALTER TABLE referral_rewards ADD COLUMN IF NOT EXISTS applied_cents int NOT NULL DEFAULT 0;

-- Step 2: Fix apply_referral_credits_to_invoice to accept DUE invoices
...
-- Step 2b: Add advance_billing_cycle function
