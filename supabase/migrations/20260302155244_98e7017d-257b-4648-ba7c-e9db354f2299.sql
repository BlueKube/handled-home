...
BEGIN
  ...
  v_body := COALESCE(p_reason, 'Your provider application status has been updated.');

  -- 8. Emit notification with correct signature (P0 + P2 fix)
